...
for Ubuntu Xenial does not produce working executables for some of the Ragecoin Core applications.
...
causes two of the ragecoin executables to crash shortly after start up. The bug is related to the
